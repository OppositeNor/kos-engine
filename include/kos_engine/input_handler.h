...
private:
     ...
     */
    std::map<int, std::vector<KEString>> input_map;

    /**
     * @brief The key state map.
     */
    std::map<KEString, InputState> input_state_map;
...
public:
     ...
     */
    InputState GetInputState(const KEString& p_key) const;
     ...
     */
    void AddInput(const KEString& input_name, int p_key);
     ...
     */
    bool IsInputPressed(const KEString& p_key) const;
     ...
     */
    bool IsInputReleased(const KEString& p_key) const;
     ...
     */
    bool IsInputJustPressed(const KEString& p_key) const;
     ...
     */
    bool IsInputJustReleased(const KEString& p_key) const;
